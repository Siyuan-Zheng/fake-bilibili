 ...
 * @author zhengsiyuan
 */
public class GifBaseCaptcha extends BaseCaptcha {
	public GifBaseCaptcha() {
	}

	private GifBaseCaptcha(int width, int height) {
		this.width = width;
		this.height = height;
	}

	public GifBaseCaptcha(int width, int height, int len) {
		this(width, height);
		this.len = len;
	}

	public GifBaseCaptcha(int width, int height, int len, Font font) {
